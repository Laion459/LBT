...
@section('content')
    <div class="container">
        ...
        <div class="row" >
            <x-revenue-table :revenues="$revenues" />
            <x-expense-table :expenses="$expenses" />
        </div>

        <div class="row">
            <x-asset-table :assets="$assets" />
            <x-debt-table :debts="$debts" />
        </div>

        <div class="row">
            <x-credit-card-table :creditCards="$creditCards" />
        </div>

        <div class="row">
            <x-financing-table :financings="$financings" />
        </div>

        <div class="row">
            <x-result-table :results="$results" />
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Financings
            $('.update-financing').click(function() {
                var id = $(this).data('id');
                var bank = $(this).closest('tr').find('.financing-bank').val();
                var description = $(this).closest('tr').find('.financing-description').val();
                var interest_rate = $(this).closest('tr').find('.financing-interest-rate').val();
            ...
            $('.delete-financing').click(function() {
                var id = $(this).data('id');
                deleteData('/financings/' + id, 'financing-row-' + id);
            });
